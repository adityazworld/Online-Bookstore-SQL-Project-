...
FROM'‪C:\Users\kushw\Downloads\SQL Practice\Books.csv'
CSV HEADER;

-- Import Data into Customers Table
COPY Customers(Customer_ID, Name, Email, Phone, City, Country) 
FROM 'C:\Users\kushw\Downloads\SQL Practice\Customers.csv' 
CSV HEADER;

-- Import Data into Orders Table
COPY Orders(Order_ID, Customer_ID, Book_ID, Order_Date, Quantity, Total_Amount) 
FROM'‪C:\Users\kushw\Downloads\SQL Practice\Orders.csv' 
CSV HEADER;
...
-- 2) Find the average price of books in the "Fantasy" genre:
        ...
        SELECT b.genre,  AVG(price) AS average_price
		FROM Books b
		WHERE genre = 'Fantasy'
		GROUP BY b.genre;
